...
function sanitize($input,$flag){
  ...
  if($del_flag == 0){
   ...
   // return "http://".$_SERVER['HTTP_HOST']."/Group6/week3/blog/admin/".$input;
   return "http://".$_SERVER['HTTP_HOST']."/blog/admin/".$input;
   ...
   // return "http://".$_SERVER['HTTP_HOST']."/Group6/week3/blog/".$input;
   return "http://".$_SERVER['HTTP_HOST']."/blog/".$input;
